...
#python3.6 run3.py --dataset mars --logs_dir logs/mars_yita70JZ_300_10/  --yita 300  --mode Dissimilarity --max_frames 900  -b 128  --device
#python3.6 run3.py --dataset mars --logs_dir logs/mars_yita70JZ_1/  --yita 1  --mode Dissimilarity --max_frames 900  -b 128  --device 0 --resume logs/mars_yita70JZ_1/

python3.6 run_gradully.py --dataset mars --logs_dir logs/mars_gradually20_0_96/  --EF 5 --q  1 --mode Dissimilarity --max_frames 900 --device 5  -b 96 --resume logs/mars_gradually20_0_96/
